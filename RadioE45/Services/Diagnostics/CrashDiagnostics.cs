...
// Su MacCatalyst Sentry può non essere ancora inizializzato in ogni finestra di avvio e,
// prima di questa classe, l'app non aveva alcun modo di osservare un'eccezione che sfugge
// da un Task "fire-and-forget" mai atteso: Mono la considera non gestita e abortisce l'intero
// processo (SIGABRT) sul thread Finalizer al momento della garbage collection del Task
// fallito, senza lasciare traccia dell'eccezione reale nel crash report nativo.
